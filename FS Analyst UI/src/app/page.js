...
export default function Home() {
  ...
  useEffect(() => {
    axios.get('https://ec2-13-233-212-1.ap-south-1.compute.amazonaws.com/feedback')
    .then(res => {
  ...
  function handleFeedbackCreated(feedback) {
    axios.post('https://ec2-13-233-212-1.ap-south-1.compute.amazonaws.com/feedback', feedback)
    .then(res => {
  ...
  function handleFeedbackUpdate(feedback) {
    console.log(feedback)
    axios.patch('https://ec2-13-233-212-1.ap-south-1.compute.amazonaws.com/feedback', feedback)
    .then(res => {
        setFeedback(feedback)
    }).catch(err => {
      console.log(err)
  ...
  function handleFeedbackDelete(id) {
    axios.delete('https://ec2-13-233-212-1.ap-south-1.compute.amazonaws.com/feedback' + id)
    .then(res => {
        setFeedback({})
